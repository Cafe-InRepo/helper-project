...
export default ({
  ...
  subheading = "Our Team",
  description = "Our team is a group of ambitious young innovators with a big dream—to revolutionize the dining experience through technology and creativity.",
  cards = [
    {
      imageSrc: Wissem,
      position: "Founder",
